      ...
      <q-list>
        <q-item class="flex column">
           <div  class="q-gutter-sm row items-center q-mb-sm">
                    <p class="col-12 col-md-3  q-mb-none text-bold text-primary">Вид аренды</p>
          ...
          <div v-else class="q-gutter-sm row items-center q-mb-md">
            <p class="col-3 q-mb-none ">Количество км</p>
            <q-input
              dense
          ...
          <q-btn no-caps  @click="sendMsg" :loading="loading" color="primary" unelevated label="Отправить">
